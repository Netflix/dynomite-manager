...
public class RetryableCallableTest {
		...
		@Test public void testCallbackOK() throws Exception {

				RetryableCallable<String> callback = new RetryableCallable<String>(1, 1000L) {
						@Override public String retriableCall() throws Exception {
								return "OK";
						}
				};
		...
		@Test public void testCallbackRetry1() throws Exception {
		...
		@Test(expected = RuntimeException.class) public void testCallbackRetry1WorngRetrys() throws Exception {
		...
		@Test(expected = RuntimeException.class) public void testCallbackRetry1WorngTime() throws Exception {
