 ...
 *
 */
@RunWith(JMockit.class) public class EurekaHostsSupplierTest {
		...
		@Test public void testGetSuppliers() {
				...
				Assert.assertTrue(
						"ec2-00-000-000-00.us-west-2.compute.amazonaws.com".equals(result.get(0).getHostName()));
				Assert.assertTrue(
						"ec2-00-000-000-00.us-west-2.compute.amazonaws.com".equals(result.get(0).getIpAddress()));
				Assert.assertTrue(8080 == result.get(0).getPort());

		}

		@Test(expected = RuntimeException.class) public void testGetSuppliersWithNull() {
