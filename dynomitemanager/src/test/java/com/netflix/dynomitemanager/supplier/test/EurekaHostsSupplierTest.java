...
public class EurekaHostsSupplierTest {
	...
	@Mocked(methods={"getApplication"})
	private DiscoveryClient dc;
	
	@Mocked(methods={"getInstances"})
	...
	public void testGetSuppliers(){	
		...
		new Expectations() {{
			dc.getApplication("DM_TEST"); result = app;
			app.getInstances(); result = instances;
			
			ii.getStatus(); result = InstanceInfo.InstanceStatus.UP;
			ii.getStatus(); result = InstanceInfo.InstanceStatus.UP;
			ii.getHostName(); result = "ec2-00-000-000-00.us-west-2.compute.amazonaws.com";
			ii.getHostName(); result = "ec2-00-000-000-00.us-west-2.compute.amazonaws.com";
			ii.getPort(); result = 8080;
			ii.getIPAddr(); result = "127.0.0.1";
			ii.getId(); result = "id-1";
			ii.getDataCenterInfo(); result = ai;
			ii.getDataCenterInfo(); result = ai;
		}};
		...
		Assert.assertTrue("ec2-00-000-000-00.us-west-2.compute.amazonaws.com".equals( result.get(0).getHostName() ));
		Assert.assertTrue( "ec2-00-000-000-00.us-west-2.compute.amazonaws.com".equals(result.get(0).getIpAddress()) );
