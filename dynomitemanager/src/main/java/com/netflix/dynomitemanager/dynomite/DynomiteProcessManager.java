...
public class DynomiteProcessManager implements IDynomiteProcess {
    ...
    @Inject
    public DynomiteProcessManager(DynomiteConfiguration dynomiteConfig, Sleeper sleeper, InstanceState instanceState,
    ...
    /**
     * Dynomite health check performed via Redis PING command. If health check fails, then we stop Dynomite to prevent a
     * zombie Dynomite process (i.e. a situation where Dynomite is running but Redis is stopped).
     *
