...
public class TokenManager implements ITokenManager {
         ...
         */
				...
				return MAXIMUM_TOKEN.divide(BigInteger.valueOf(size)).multiply(BigInteger.valueOf(position))
		 ...
		 */
		@Override public String createToken(int my_slot, int rac_count, int rac_size, String region) {
				int regionCount = rac_count * rac_size;
				return initialToken(regionCount, my_slot, regionOffset(region)).toString();
		}

		@Override public String createToken(int my_slot, int totalCount, String region) {
				return initialToken(totalCount, my_slot, regionOffset(region)).toString();
		}

		@Override public BigInteger findClosestToken(BigInteger tokenToSearch, List<BigInteger> tokenList) {
		 ...
		 */
		@Override public int regionOffset(String dataCenter) {
