...
public class DynomitemanagerConfiguration implements IConfiguration {
    ...
    private static final String CONFIG_DYNO_REDIS_COMPATIBLE_ENGINE = DYNOMITEMANAGER_PRE
            + ".dyno.redis.compatible.engine";
    /**
    ...
    private static final String CONFIG_MAX_WRITE_BUFFER_NUMBER = DYNOMITEMANAGER_PRE
            + ".dyno.ardb.rocksdb.maxwritebuffernumber";
    private static final String CONFIG_MIN_WRITE_BUFFER_NAME_TO_MERGE = DYNOMITEMANAGER_PRE
            + ".dyno.ardb.rocksdb.minwritebuffernametomerge";
